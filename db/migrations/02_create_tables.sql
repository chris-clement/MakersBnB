...
CREATE TABLE bookings (id SERIAL PRIMARY KEY, user_id INTEGER REFERENCES users(id), space_id INTEGER REFERENCES spaces(id), date VARCHAR(60), bookable BOOLEAN);

ALTER TABLE bookings DROP COLUMN bookable;
